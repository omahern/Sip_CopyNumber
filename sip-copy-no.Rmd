...
```{r si-fig-1-again, fig.height=8,fig.width=8, message=FALSE, error=FALSE, warning=FALSE}
...
```{r si-fig-1-good, fig.height=8,fig.width=8, message=FALSE, error=FALSE, warning=FALSE}
setwd("/Users/oliviaahern/Documents/GitHub/SIP_CopyNumber")
...
#ggsave('rmaxplot.svg', plot=gplot1, dpi=300, width=8,height=4)
```
...
## IOC
```{r ioc_1, message=FALSE, error=FALSE, warning=FALSE}
qsip_data
...
```{r legend-1c, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=8, fig.height=5}
...
```{r copy-2ag2, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=8, fig.height=5}
...
```{r copy-ico, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=8, fig.height=5}
...
```{r copy-ico2, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=8, fig.height=5}
library(ggh4x)
...
### stats generated from here
```{r copy-5, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=8, fig.height=5}
...
### ASV 1
```{r asv1,message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=7, fig.height=4 }
...
### ASV 2
```{r asv2, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=7, fig.height=4}
...
### ASV 3 
```{r asv3, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=7, fig.height=4}
...
### ASV 4
```{r asv4, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=7, fig.height=4}
...
```{r batch-a, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=7, fig.height=4}
...
```{r batch-b, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=5, fig.height=5}
...
```{r batch-bb, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=6, fig.height=4}
multi=subset(batch_incorp, Substrate=="Multi")
single=subset(batch_incorp, Substrate=="Single")
...
ma_fit  <- ma(as.numeric(Single) ~ as.numeric(Multi), data = both, slope.test = 1, elev.test = 0)
sma_fit <- sma(as.numeric(Single) ~ as.numeric(Multi), data = both, slope.test = 1, elev.test = 0)
summary(ma_fit); summary(sma_fit)

t.test(shared$Single, shared$Multi, paired = TRUE)
wilcox.test(shared$Single, shared$Multi, paired = TRUE)   # if differences are skewed
plot(sma_fit, which = "residual")  
```

### batch multi eaf vs single eaf 
```{r batch-bbc, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=6, fig.height=4}
...
```{r batch-b1, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=5, fig.height=5}
