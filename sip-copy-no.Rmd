...
```{r legend-1, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=8, fig.height=5}
...
```{r legend-2, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=8, fig.height=5}
...
```
#### heatmap 
```{r batch-c, message=FALSE, error=FALSE, warning=FALSE, dpi=300, fig.width=4, fig.height=8}
